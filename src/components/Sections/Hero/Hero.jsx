...
export default function Home(){
    return(
        <section id="home" className="w-full h-screen flex flex-col items-center justify-center text-center gap-5 bg-[url('/images/abstract.png')] bg-no-repeat bg-cover bg-center">
